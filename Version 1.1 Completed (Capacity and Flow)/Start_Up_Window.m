...
set(handles.text2, 'String', 'Please enter the size of the system you wish to simulate:'); %Initialize text
...
if (1 <= simSize) && (simSize <= 10) % Size of system limitations, lower limit should not be modified, upper limit however can be changed
    input = struct('Size', simSize);
    close; % Close this window
    Simulation_Window(input); % Open the Construction Window
else
